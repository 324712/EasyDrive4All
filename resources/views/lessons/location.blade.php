...
@section('content')
    ...
    <div class="container">
        <form action="{{ route('lessons.location', ['id' => $lessons->id]) }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-4 invisible">
                    <div class="form-floating mb-3">
                        <select class="form-select @error('lesson_type') is-invalid @enderror" id="lesson_type" name="lesson_type" aria-label="lesson_type" required>
                            <option selected value="{{ $lessons->lesson_type }}">{{ $lessons->lessonType->name }}</option>
                ...
                <div class="col-4 invisible">
                    <div class="form-floating mb-3">
                        <select class="form-select @error('student_id') is-invalid @enderror" id="student_id" name="student_id" aria-label="student_id" required>
                            <option selected value="{{ $lessons->student->id }}">{{ $lessons->student->fullname }}</option>
                            <option disabled>Maak een keuze</option>
                ...
                <div class="col-4 invisible">
                    <div class="form-floating mb-3">
                        <select class="form-select @error('instructor_id') is-invalid @enderror" id="instructor_id" name="instructor_id" aria-label="instructor_id" required>
                            <option selected value="{{ $lessons->instructor->id }}">{{ $lessons->instructor->fullname }}</option>
                            <option disabled>Maak een keuze</option>
                ...
                <div class="col-12">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('location') is-invalid @enderror" value="{{ $lessons->location }}" id="location" name="location" placeholder="location" required>
                ...
                <div class="col-4">
                    <div class="form-floating mb-3">
                        <input type="date" class="form-control @error('date') is-invalid @enderror" value="{{ $lessons->date }}" id="date" name="date" placeholder="date" required>
                        <label for="date">Datum</label>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-floating mb-3">
                        <input type="time" class="form-control @error('begin_time') is-invalid @enderror" value="{{ $lessons->begin_time }}" id="begin_time" name="begin_time" placeholder="begin_time" required>
                        <label for="begin_time">Begin tijd</label>
                    </div>
                </div>
                <div class="col-4">
                    <div class="form-floating mb-3">
                        <input type="time" class="form-control @error('end_time') is-invalid @enderror" value="{{ $lessons->end_time }}" id="end_time" name="end_time" placeholder="end_time" required>
                ...
                <div class="col-12 invisible">
                    <div class="form-floating mb-3">
                        <input type="text" class="form-control @error('information') is-invalid @enderror" value="{{ $lessons->information }}" id="information" name="information" placeholder="information">
